...
public class InVsExistsDemo {
    ...
    public static void runDemo() {
        ...
        DbConnectionHelper.executeSqlScript(
                "DELETE FROM interview_emp;",
                "DELETE FROM interview_dept;",
                "INSERT INTO interview_dept (dept_id, dept_name) VALUES (1, '技术部'), (2, '运营部'), (3, '空置部门(无员工)');",
                "INSERT INTO interview_emp (emp_id, emp_name, dept_id) VALUES (101, '张工', 1), (102, '李工', 1), (103, '赵运营', 2), (104, '实习无部门人员', NULL);"
        );
